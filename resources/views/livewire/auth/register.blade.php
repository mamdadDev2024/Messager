<form wire:submit='register' class=" p-2 rounded-2xl border mt-20 bg-gray-300 max-w-xs w-full flex flex-col gap-2">
    ...
    <div class=' p-1 flex flex-col gap-3 ' >
        ...
        <x-element.input wire:model='username' placeholder="please insert your username ..."/>
        @error('username')
            <span class=" p-2 bg-red-500 w-full h-14 rounded-2xl text-center items-center flex flex-col justify-center">{{$message}}</span>
        @enderror
    </div>
    ...
    <div class=' p-1 flex flex-col gap-3 ' >
        ...
        <x-element.input type='password' wire:model='password_confirmation' placeholder="please confirm your password ..."/>
    </div>
